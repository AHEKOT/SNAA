...
conversation_id = "default"                                 # айди диалога в ChatGPT. Можно оставить "default" тогда значение будет браться из файла config.py
...
def run():
  ...
  vk_upload(img_count,vk_group_id,vk_group_name,vk_posting_type,disk_folder_id,vk_message_prompt,notifications)
  return
